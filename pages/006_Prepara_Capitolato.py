...
st.set_page_config(page_title="Prepara Capitolato", layout="wide", initial_sidebar_state="expanded")
...
st.markdown('<h1>Prepara Capitolato</h1>', unsafe_allow_html=True)
